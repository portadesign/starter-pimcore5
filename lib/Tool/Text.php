            ...
            for ($i = 0; $i < count($matches[2]); $i++) {
                ...
                if ($element instanceof Element\ElementInterface) {
                    if ($matches[1][$i] == 'a') {
                        ...
                        if ($params['document'] && $params['document']->getMetadata('language')) {
                            $language = $params['document']->getMetadata('language');
                        }
                        elseif ($params['object'] && ($params['object'] instanceof Localizedfield)) {
